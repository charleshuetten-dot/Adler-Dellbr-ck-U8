...
const ELTERN_LEITFADEN=[
  ...
  {emo:"🚗", t:"Bringen & Abholen", d:"Bitte bringt euer Kind nicht deutlich vor Beginn und fahrt dann wieder weg – vor dem offiziellen Start gibt es keine Aufsicht. Holt es ebenso pünktlich nach dem Ende wieder ab. Ein Kind, das allein wartet, ist kein schöner Abschluss einer Einheit. Neu: Tragt am Termin in der App kurz ein, wer euer Kind abholt („Oma“, „fährt bei Matteo mit“) – dann geben wir es am Platz nur in die richtigen Hände."},
  ...
  {emo:"📸", t:"Fotos & Datenschutz", d:"Teilt Fotos und kurze Videos vom Team bitte über die Event-Galerie in der App statt über WhatsApp: Dort sehen sie nur eingeloggte Team-Eltern, die Foto-Freigaben der Familien werden respektiert, das Trainerteam kann moderieren – und Löschen ist wirklich Löschen. Bei WhatsApp landet jedes Bild als Kopie auf allen Geräten der Gruppe und in deren Backups; zurückholen kann man es nie. Ob und wo euer Kind zu sehen sein darf, steuert ihr jederzeit unter „Datenschutz & Freigaben“."},
