...
function _trsvpRowHtml(t,me,pre){
  ...
  return `<div id="${pre}-${t.id}" style="border:var(--border-s);border-left:3px solid ${m.col};border-radius:12px;padding:10px 12px;margin-bottom:8px;background:var(--surface)">
