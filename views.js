...
async function renderHome(){
  ...
  box.innerHTML=`
    ...
    <button onclick="toepfeOpen()" style="width:100%;min-height:44px;margin-top:8px;border:var(--border-s);border-radius:var(--rl);cursor:pointer;font-family:inherit;font-size:13px;font-weight:700;color:var(--text);background:var(--surface)">🍖 Event-Kasse (Grillfest &amp; Co.)</button>
