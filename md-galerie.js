...
async function fotoAmpelOpen(){
  ...
  c.innerHTML=`
    ...
    <textarea id="fa-text" rows="5" placeholder="Leer = Standardtext der App. Hier eure DFB-/LSB-Formulierung einsetzen." style="width:100%;padding:9px;border:1px solid var(--feld-rand);border-radius:8px;font-family:inherit;font-size:12px;box-sizing:border-box;resize:vertical;background:var(--surface);color:var(--text)">${esc(txt)}</textarea>
